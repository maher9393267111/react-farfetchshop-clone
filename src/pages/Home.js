...
<div className={`h-0 absolute min-w-[100%]   ${ index > 0 ? ` left-${index} ` : " "}  bottom-[-44px]  
...
<div className={` group-hover:h-auto transition-all duration-150 hidden group-hover:block mt-[-6px] inside-it  b h-0  pl-12  pt-5      pb-12`}>
...
<li  className=" mb-4  first:mt-6 font-thin">{item}</li>
...
{/* ----right side image */}
    ...
    dsdsdfgfffffffffffffffffffffffffffffffffff
    <h2>dsdsgggggggggggggggggggggggggggd</h2>
    <h2>dsdsd</h2>
    </div>
